-- Credits to Abstract and Deity for https://github.com/deeeity/mercury-lib
...
local Library = {
	Themes = {
		...
		Ascend = {
			Main = Color3.fromHSV(262/360, 60/255, 34/255),
			Secondary = Color3.fromHSV(240/360, 40/255, 63/255),
			Tertiary = Color3.fromRGB(157, 79, 202),
	...
	DragSpeed = 0.06,
	LockDragging = false,
	ToggleKey = Enum.KeyCode.RightAlt, -- Right Alt
	UrlLabel = nil,
	Url = nil
...
function Library:create(options)
	...
	if readfile and writefile and isfile then
		if not isfile("AscendUISettings.json") then
			writefile("AscendUISettings.json", HTTPService:JSONEncode(settings))
		end
		settings = HTTPService:JSONDecode(readfile("AscendUISettings.json"))
	...
	creditsTab:credit{Name = "Thinking Curved", Description = "Developer", Discord = "thinking_curved", Github="https://github.com/AscendScripting/"}
  creditsTab:credit{Name = "Rafael S.R.", Description = "Developer", Discord = "thinking_real", Github="https://github.com/rsley"}
	...
	creditsTab:credit{Name = "Repository", Description = "UI Library", Github="https://github.com/AscendScripting/Mercury/blob/main/script.lua"}

  getgenv().AC_CREDITSTAB = creditsTab
  getgenv().AC_SETTINGSTAB = settingsTab
	return mt
end
